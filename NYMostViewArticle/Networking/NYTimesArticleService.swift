...
//NY_Times_Api_Key"
private var kApiKey = "a9edf20f94464a769435abb55e0d9319"
...
class NYTimesArticleServiceImpl: NYTimesArticleService {
    ...
    func searchMostViewedArticle(duration: String, completion: @escaping QueryResult) {
        if var urlComponents = URLComponents(string: "http://api.nytimes.com/svc/mostpopular/v2/mostviewed/all-sections/\(duration).json") {
